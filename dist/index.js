...
require('@whcg/whcg-material-styles/color.js');
require('@whcg/whcg-material-styles/typography.js');
...
$_documentContainer.innerHTML = `<dom-module id="whcg-text-field-theme" theme-for="vaadin-text-field">
  <template>
    <style>
      :host {
        display: inline-flex;
